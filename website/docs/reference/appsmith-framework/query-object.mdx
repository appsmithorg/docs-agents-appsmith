...
In certain scenarios, such as when running a query inside a loop, it may be necessary to pass parameters to the query with values that are contextual to the execution. For more information, see [Pass Parameters to Queries](https://docs.appsmith.com/connect-data/how-to-guides/how-to-pass-params-to-an-api).
...
## See also
- [Pass Runtime Parameters to Queries](https://docs.appsmith.com/connect-data/how-to-guides/how-to-pass-params-to-an-api)
